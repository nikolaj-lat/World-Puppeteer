---
name: hxh-canon
description: Hunter x Hunter canon-source profile for the active HxH world. Use only when TARGET_WORLD_ROOT resolves to hxh_hunter_exam_campaign_rebuild.
---

# HxH Canon Profile

Use this profile only for the active Hunter x Hunter world.

- Treat the manga through approximately chapter 410 as the canon source of truth.
