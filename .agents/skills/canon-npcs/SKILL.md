...
**Record new conventions.** When a new hiddenInfo style rule is established during approval (naming conventions, title formatting, structural patterns), add it to the hiddenInfo Style Rules section in the project's NPC progress tracking file — not to the skill, memory, or AGENTS.md.
