...
Perform a thorough narrative review of all NPCs. Run `node .Codex/scripts/review-npcs.js` to get stripped narrative data, then analyze.

## Setup

1. Run `node .Codex/scripts/review-npcs.js` — outputs NPC narrative text with world-background and entity name lists
